import { AfterContentChecked, AfterContentInit, Component, EventEmitter, Output } from '@angular/core';
...
export class HorseComponent implements AfterContentInit, AfterContentChecked {
