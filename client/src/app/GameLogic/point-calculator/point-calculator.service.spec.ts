...
//         expect(servicePoints.tileToString(servicePoints.wordPlaced(action, game)).toLowerCase()).toBe('bateaux');
...
//     //     ];
//     //     const action = new PlaceLetter(player2, 'bateau', { x: 0, y: 0, direction: Direction.Horizontal });
//     //     expect(servicePoints.calculatePointsOfWord(word, action, game)).toBe(totalPointsOfWord);
//     // });
...
//     //         const oldAction = new PlaceLetter(player1, 'at', { x: 0, y: 2, direction: Direction.Vertical });
...
//     //         const action = new PlaceLetter(player2, 'bake', { x: 2, y: 0, direction: Direction.Horizontal });
