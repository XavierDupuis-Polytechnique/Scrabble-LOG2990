...
describe('User', () => {
    ...
    it('should get one letter from rack', () => {
        ...
        expect(user.getLettersFromRack(mockLetters)[0]).toBe(expectedLetters[0]);
    });

    it('should get all letters from rack', () => {
        const letterRack = user.letterRack;
        const expectedLetters = [letterRack[4], letterRack[1], letterRack[2], letterRack[3], letterRack[0]];
