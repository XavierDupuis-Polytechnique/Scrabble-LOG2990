...
import { BOARD_DIMENSION, BOARD_MAX_POSITION, BOARD_MIN_POSITION } from '@app/game-logic/constants';
...
import { copyGrid } from '@app/game-logic/utils';
...
describe('FourCorners', () => {
    ...
    beforeEach(() => {
        ...
        params.currentGrid = copyGrid(emptyGrid);
    });
